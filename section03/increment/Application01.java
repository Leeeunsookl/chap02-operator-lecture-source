...
public class Application01 {
    ...
    public static void main(String[] args) {
        ...
        *   */
        ...
        System.out.println("firstNum = " + firstNum);       //둘이 분리됐다는 거! result는 60으로 나오고, 끝났으니 firstNum은 1을 더해준 값으로 바뀜
        ...
        System.out.println("secondNum = " + secondNum);     //result는 바뀌지만 연산자의 값은 역시 바뀐다
